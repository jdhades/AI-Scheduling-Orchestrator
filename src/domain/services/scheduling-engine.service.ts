...
export class SchedulingEngine {
    ...
    run(
        ...
        const quality = this.analyzeQuality(assignments, unfilledShifts, shifts, histories, strategy.type);
    ...
    private analyzeQuality(
        ...
        const fairnessVariance = this.fairnessCalc.computeVariance([...scores.values()]);

        const demandCoveragePercent = allShifts.length > 0
