...
import type { SchedulingStrategy, SemanticConstraint } from '../strategies/scheduling-strategy.interface';
import { SchedulingEngine, type SchedulingOptions, type ScheduleResult } from '../services/scheduling-engine.service';
...
export class ScheduleAggregate extends AggregateRoot {
    ...
    generate(
        ...
        this._result = this.engine.run(shifts, employees, histories, strategy, options);
    ...
    get assignments(): ShiftAssignment[] { return [...this._assignments]; }
    get unfilledShifts(): Shift[] { return [...this._unfilledShifts]; }
    get result(): ScheduleResult | null { return this._result; }
}
