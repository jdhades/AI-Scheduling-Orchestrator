...
export class DemandWeight {
  ...
  static create(value: number): DemandWeight {
    if (
      ...
      value < DemandWeight.MIN ||
      value > DemandWeight.MAX
    ) {
      throw new Error(
  ...
  static low(): DemandWeight {
    return new DemandWeight(2);
  }
  static medium(): DemandWeight {
    return new DemandWeight(5);
  }
  static high(): DemandWeight {
    return new DemandWeight(8);
  }
  static critical(): DemandWeight {
    return new DemandWeight(10);
  }
