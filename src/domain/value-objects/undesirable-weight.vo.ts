...
export class UndesirableWeight {
  ...
  static create(value: number): UndesirableWeight {
    if (
      ...
      value < UndesirableWeight.MIN ||
      value > UndesirableWeight.MAX
    ) {
      throw new Error(
  ...
  static normal(): UndesirableWeight {
    return new UndesirableWeight(0);
  }
  static moderate(): UndesirableWeight {
    return new UndesirableWeight(4);
  }
  static heavy(): UndesirableWeight {
    return new UndesirableWeight(7);
  }
  static extreme(): UndesirableWeight {
    return new UndesirableWeight(10);
  }
