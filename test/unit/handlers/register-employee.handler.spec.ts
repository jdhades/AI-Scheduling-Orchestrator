...
describe('RegisterEmployeeHandler', () => {
  ...
  it('should create an employee, save it, and commit domain events', async () => {
    ...
    const aggregate = mockPublisher.mergeObjectContext.mock
      .calls[0][0] as Employee;
  ...
  it('should call commit() after save()', async () => {
    ...
    const saveOrder = (mockEmployeeRepo.save as jest.Mock).mock
      .invocationCallOrder[0];
    const commitOrder = (aggregate.commit as jest.Mock).mock
      .invocationCallOrder[0];
