...
describe('PhoneNumber Value Object', () => {
    ...
    describe('create()', () => {
        ...
        it('should throw when phone number does not start with +', () => {
            expect(() => PhoneNumber.create('12345678901')).toThrow('Invalid phone number');
        });
        ...
        it('should throw when phone number contains letters', () => {
            expect(() => PhoneNumber.create('+1234abc7890')).toThrow('Invalid phone number');
        });
        ...
        it('should throw when phone number exceeds 15 digits', () => {
            expect(() => PhoneNumber.create('+1234567890123456')).toThrow('Invalid phone number');
        });
    });
