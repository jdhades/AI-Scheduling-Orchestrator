...
describe('RulePriority Value Object', () => {
  ...
  describe('comparison methods', () => {
    it('legal should be higher than semantic', () => {
      expect(RulePriority.legal().isHigherThan(RulePriority.semantic())).toBe(
        true,
      );
    });
    ...
    it('semantic should be higher than preference', () => {
      expect(
        RulePriority.semantic().isHigherThan(RulePriority.preference()),
      ).toBe(true);
    });

    it('preference should NOT be higher than legal', () => {
      expect(RulePriority.preference().isHigherThan(RulePriority.legal())).toBe(
        false,
      );
    });
...
describe('RuleType Value Object', () => {
  ...
  describe('equals()', () => {
    it('same type should be equal', () => {
      expect(
        RuleType.create('restriction').equals(RuleType.create('restriction')),
      ).toBe(true);
    });

    it('different types should not be equal', () => {
      expect(
        RuleType.create('restriction').equals(RuleType.create('preference')),
      ).toBe(false);
    });
  });
});
