...
function makeShift(id: string, requiredSkillId: string | null, startHour = 8, endHour = 16): Shift {
...
describe('ScheduleValidatorService', () => {
    ...
    it('should return valid when employee exists, has skill and no overlap', () => {
        ...
        const result = validator.validate('s1', 'e1', [emp], [shift], emptyAssigned, NO_SEMANTIC_RULES);
    ...
    it('should return invalid when employee does not exist', () => {
        ...
        const result = validator.validate('s1', 'NON_EXISTENT_EMP', [emp], [shift], emptyAssigned, NO_SEMANTIC_RULES);
    ...
    it('should return invalid when shift does not exist', () => {
        ...
        const result = validator.validate('NON_EXISTENT_SHIFT', 'e1', [emp], [], emptyAssigned, NO_SEMANTIC_RULES);
    ...
    it('should return invalid when employee lacks required skill', () => {
        ...
        const result = validator.validate('s1', 'e1', [empNoSkill], [shift], emptyAssigned, NO_SEMANTIC_RULES);
    ...
    it('should return invalid when employee has overlapping shift', () => {
        ...
        const result = validator.validate('s2', 'e1', [emp], [shift1, shift2], emptyAssigned, NO_SEMANTIC_RULES);
    ...
    it('should accumulate multiple violations in a single result', () => {
        ...
        const result = validator.validate('NON_SHIFT', 'NON_EMP', [], [], emptyAssigned, NO_SEMANTIC_RULES);
        expect(result.valid).toBe(false);
