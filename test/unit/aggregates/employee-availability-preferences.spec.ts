...
function makeEmployee(customAvailability?: EmployeeAvailability[], customPreferences?: EmployeePreference[]): Employee {
...
describe('EmployeeAvailability Value Object', () => {
    ...
    it('should throw if dayOfWeek is out of range', () => {
        ...
        expect(() => new EmployeeAvailability('id', -1, '09:00', '17:00')).toThrow();
    });

    it('coversShift() → true when shift day and times fall within window', () => {
        // Monday (dayOfWeek=1) 09:00–17:00 window
        const availability = new EmployeeAvailability('avail-1', 1, '09:00', '17:00');
