...
function makeTemplate(dayOfWeek: number, startTime: string, endTime: string): ShiftTemplate {
...
describe('ShiftTemplate.instantiateForWeek()', () => {
    it('should throw when dayOfWeek is invalid', () => {
        expect(() => makeTemplate(7, '08:00', '16:00')).toThrow('Invalid dayOfWeek');
        expect(() => makeTemplate(-1, '08:00', '16:00')).toThrow('Invalid dayOfWeek');
    });
